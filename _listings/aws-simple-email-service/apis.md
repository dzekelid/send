...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/apis.md
...
- name: AWS Simple Email Service API - Get Send Quota
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actiongetsendquota-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actiongetsendquota-get-openapi.md
- name: AWS Simple Email Service API - Get Send Statistics
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actiongetsendstatistics-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actiongetsendstatistics-get-openapi.md
- name: AWS Simple Email Service API - Send Bounce
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actionsendbounce-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actionsendbounce-get-openapi.md
- name: AWS Simple Email Service API - Send Email
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actionsendemail-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actionsendemail-get-openapi.md
- name: AWS Simple Email Service API - Send Raw Email
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actionsendrawemail-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-email-service/actionsendrawemail-get-openapi.md
- name: AWS Simple Email Service API - Get Send Quota
  x-api-slug: actiongetsendquota-get
  description: Returns the user's current sending limits.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Application-Services_AmazonSES.png
