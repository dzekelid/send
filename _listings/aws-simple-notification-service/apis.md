...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-notification-service/apis.md
...
- name: AWS Simple Notification Service API - Publish
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-notification-service/actionpublish-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/send/master/_listings/aws-simple-notification-service/actionpublish-get-openapi.md
- name: AWS Simple Notification Service API - Publish
  x-api-slug: actionpublish-get
  description: Sends a message to all of a topic's subscribed endpoints.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Mobile-Services_AmazonSNS.png
